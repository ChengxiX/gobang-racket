...
;获取console输入
;(define get-two-from-console (lambda () (cons (string->number (read-line)) (string->number (read-line)))))
...
;主程序
;(define AI-first (string->number (read-line)))
;(define attack-ratio (string->number (read-line)))
;(define aim-depth-global (string->number (read-line)))
